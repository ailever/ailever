...
setup(name                = 'ailever',
      ...
      install_requires    = ['dash', 'dash_bootstrap_components', 'plotly', 'beautifulsoup4', 'yahooquery', 'finance-datareader', 'statsmodels>=0.13.0', 'matplotlib', 'pandas', 'numpy', 'requests', 'jpype1==1.2.0', 'tweepy==3.7.0', 'konlpy', 'nltk'],
