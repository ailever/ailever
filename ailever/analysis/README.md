...
- [Analysis-FactorAnalysis](https://github.com/ailever/ailever/blob/master/ailever/analysis/ana-factor_analysis.md)
- [Analysis-TimeSeriesAnalysis](https://github.com/ailever/ailever/blob/master/ailever/analysis/ana-time_series_analysis.md)
- [Analysis-TextAnalysis](https://github.com/ailever/ailever/blob/master/ailever/analysis/ana-text_analysis.md)
...
# eda.not_null_columns = eda.normal_columns + eda.abnormal_columns = eda.numerical_columns + eda.categorical_columns
eda.normal_columns    # columns not having missing values 
eda.abnormal_columns  # columns having missing values
eda.numerical_columns
...
numerical_frame = eda.frame[eda.integer_columns+eda.float_columns]

scatter_matrix(numerical_frame, figsize=(25,15), hist_kwds=dict(edgecolor='white'))
...
Evaluation('regression').about(y_true=y_true, y_pred=y_pred)
```
