...
U_r = cell.weights[1][:, 4:8]                                                 # U_r.shape               # (4,4)
U_c = cell.weights[1][:, 8:12]                                                # U_c.shape               # (4,4)
b_z = cell.weights[2][0:4]                                                    # b_z.shape               # (, 4)
b_r = cell.weights[2][4:8]                                                    # b_r.shape               # (, 4)
b_c = cell.weights[2][8:12]                                                   # b_c.shape               # (, 4)
...
U_r = layer.cell.weights[1][:, 4:8]                                                 # U_r.shape                    # (4,4)
U_c = layer.cell.weights[1][:, 8:12]                                                # U_c.shape                    # (4,4)
b_z = layer.cell.weights[2][0:4]                                                    # b_z.shape                    # (, 4)
b_r = layer.cell.weights[2][4:8]                                                    # b_r.shape                    # (, 4)
b_c = layer.cell.weights[2][8:12]                                                   # b_c.shape                    # (, 4)
