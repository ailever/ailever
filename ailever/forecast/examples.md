...
models['XGBRegressor'] = XGBRegressor(subsample=0.3, colsample_bylevel=0.3, colsample_bynode=0.3, colsample_bytree=0.3, learning_rate=0.05, n_estimators=100, reg_lambda=0, reg_alpha=0, random_state=2022).fit(X_train.values, y_train.values.ravel())
