...
models['GradientBoostingRegressor'] = GradientBoostingRegressor(subsample=0.3, alpha=0.1, learning_rate=0.05, loss='huber', criterion='friedman_mse', n_estimators=1000, random_state=2022).fit(X_train.values, y_train.values.ravel())
models['XGBRegressor'] = XGBRegressor(subsample=0.3, learning_rate=0.05, n_estimators=100, reg_lambda=0, reg_alpha=0, random_state=2022).fit(X_train.values, y_train.values.ravel())
