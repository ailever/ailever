...
for i in range(11, 20):
    prophet.evaluate(model_name='GradientBoostingClassifier', trainstartdate='2015-03-01', teststartdate='2019-10-01', code='ARE', lag_shift=i, sequence_length=5, comment=None, visual_on=False)
for i in range(11, 20):
...
prophet.analyze(prophet.X.loc[teststartdate:], prophet.y[teststartdate:], timeline=prophet.dataset['Close'].loc[teststartdate:], 
                params=dict(max_depth=4, min_samples_split=100, min_samples_leaf=100), 
                plots={'FeatureImportance':True, 'DecisionTree':True, 'ClassificationReport':True, 'Timeline':True})
```
...
prophet = StockProphet(code='035420', lag_shift=5, sequence_length=10, trainstartdate='2015-03-01', teststartdate='2019-10-01')
prophet.evaluate(model_name='CatBoostClassifier', trainstartdate='2021-03-01', teststartdate='2021-10-02', code='000660', lag_shift=30, sequence_length=10, comment=None, visual_on=True)
